...
const memorialDocs = [
  {
    ...
    meta: {
      description:
        'A beloved mother of four and grandmother of eleven, Margaret will be remembered for her warmth and unshakeable faith.',
      image: null,
    },
    serviceDetails: {
      pending: false,
  ...
  },
  {
    ...
    meta: {
      description:
        'Robert served his community as a volunteer firefighter for over thirty years. He is survived by his wife of fifty-two years, Carol.',
      image: null,
    },
    serviceDetails: {
      pending: true,
  ...
  },
  {
    ...
    meta: {
      description:
        'Dorothy was a retired schoolteacher who touched the lives of hundreds of students across Montgomery County over her forty-year career.',
      image: null,
    },
    serviceDetails: {
      pending: false,
...
const postDocs = [
  {
    ...
    meta: {
      description:
        'Pre-planning your funeral is one of the most thoughtful gifts you can give your loved ones. Here is what you need to know.',
      image: null,
    },
  ...
  },
  {
    ...
    meta: {
      description:
        'Grief is a deeply personal journey. We share some resources and insights to help families navigate this difficult time.',
      image: null,
    },
  ...
  },
  {
    ...
    meta: {
      description:
        'Choosing between cremation and burial is a deeply personal decision. We walk through the key considerations for each.',
      image: null,
    },
